		...
		<form method="post" enctype="multipart/form-data">
			...
			<?php
				...
				if(is_array($settings)){
					...
					echo "<input type='password' id='textbox' name='password'  value='".htmlspecialchars($settings['password'])."' placeholder='Type in new password'/>";
					echo "<input type='password' id='textbox' name='password2'  value='".htmlspecialchars($settings['password'])."' placeholder='Confirm new password'/>";
